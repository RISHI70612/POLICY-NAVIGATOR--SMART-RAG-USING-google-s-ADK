    ...
    try:
        ...
        try:
            ...
            if result.get("status") == "success":
                ...
                print(f"[FAIL] Assessment failed: {result.get('error', 'Unknown error')}")
        ...
        try:
            ...
            if result.get("status") == "success":
                print("[OK] Policy Summary:")
                print(f"  Summary: {result.get('summary', 'N/A')[:300]}...")
            else:
                print(f"[FAIL] Summary failed: {result.get('error', 'Unknown error')}")
        ...
        try:
            ...
            if result.get("status") == "success":
                ...
                print(f"[FAIL] Audit failed: {result.get('error', 'Unknown error')}")
        ...
        print("[OK] Demonstrated key Policy Navigator features:")
        ...
        print("\n[OK] All tools working correctly!")
        ...
        print(f"\n[FAIL] Workflow demo failed: {str(e)}")
        import traceback
